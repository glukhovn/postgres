...
spghandler(PG_FUNCTION_ARGS)
{
	...
	amroutine->amcanorderbyop = spgcanorderbyop;
...
Expr *
spgcanorderbyop(IndexOptInfo *index, PathKey *pathkey, int pathkeyno,
				Expr *orderby_clause, int *indexcol_p)
{
	int		indexcol;

	/*
	 * We allow any column of the SP-GiST index to match each pathkey;
