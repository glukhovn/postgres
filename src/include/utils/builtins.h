...
extern Datum compression_handler_in(PG_FUNCTION_ARGS);
extern Datum compression_handler_out(PG_FUNCTION_ARGS);
...
extern int	varstr_cmp(const char *arg1, int len1,
					   const char *arg2, int len2, Oid collid);
