...
DECLARE_UNIQUE_INDEX(pg_compression_oid_index, 3370, on pg_compression using btree(oid oid_ops));
#define CompressionMethodOidIndexId  3370
DECLARE_UNIQUE_INDEX(pg_compression_name_index, 3371, on pg_compression using btree(cmname name_ops));
#define CompressionMethodNameIndexId  3371
...
DECLARE_UNIQUE_INDEX(pg_jsonbc_dict_name_index, 3380, on pg_jsonbc_dict using btree(dict oid_ops, name text_ops));
