 ...
 * GIN json_ops
 */
DATA(insert (	3439   114  114  7 s 3428 2742 0 ));
DATA(insert (	3439   114   25  9 s 3429 2742 0 ));
DATA(insert (	3439   114 1009 10 s 3430 2742 0 ));
DATA(insert (	3439   114 1009 11 s 3431 2742 0 ));

/*
 * GIN json_path_ops
 */
DATA(insert (	3440   114  114  7 s 3428 2742 0 ));
