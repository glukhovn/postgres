...
CATALOG(pg_attribute,1249) BKI_BOOTSTRAP BKI_WITHOUT_OIDS BKI_ROWTYPE_OID(75) BKI_SCHEMA_MACRO
{
	...
	/* attribute's compression method or InvalidOid */
	Oid			attcompression;
	...
	/* Column-level compression method options */
	text		attcmoptions[1];
#endif
