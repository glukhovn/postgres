...
DESCR("I/O");
DATA(insert OID = 3373 (  compression_handler_in	PGNSP PGUID 12 1 0 0 0 f f f f f f i s 1 0 3372 "2275" _null_ _null_ _null_ _null_ _null_ compression_handler_in _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 3374 (  compression_handler_out	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 2275 "3372" _null_ _null_ _null_ _null_ _null_ compression_handler_out _null_ _null_ _null_ ));
DESCR("I/O");
...
DESCR("I/O");
DATA(insert OID = 3795 (  json             PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 114 "3802" _null_ _null_ _null_ _null_ _null_ jsonb_to_json _null_ _null_ _null_ ));
...
DATA(insert OID = 3399 (  json_extract_keys			PGNSP PGUID 12 1 100 0 0 f f f f t t i s 1 0 25 "114" _null_ _null_ _null_ _null_ _null_ json_extract_keys _null_ _null_ _null_ ));
...
DESCR("get name id from jsonbc dictionary");
DATA(insert OID = 3999 (  jsonbc_get_dict_id	   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 26 "114" _null_ _null_ _null_ _null_ _null_ jsonbc_get_dict_id _null_ _null_ _null_ ));
...
DATA(insert OID = 3343 (  json_null_cm_handler	PGNSP PGUID 12 1 0 0 0 f f f f t f v s 1 0 3372 "2281" _null_ _null_ _null_ _null_ _null_	json_null_cm_handler _null_ _null_ _null_ ));
DESCR("json compression method handler");
DATA(insert OID = 3344 (  jsonb_null_cm_handler	PGNSP PGUID 12 1 0 0 0 f f f f t f v s 1 0 3372 "2281" _null_ _null_ _null_ _null_ _null_	jsonb_null_cm_handler _null_ _null_ _null_ ));
...
DESCR("I/O");
DATA(insert OID =  3796 (  jsonb            PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 3802 "114" _null_ _null_ _null_ _null_ _null_ json_to_jsonb _null_ _null_ _null_ ));
...
DATA(insert OID = 3398 (  jsonb_extract_keys		PGNSP PGUID 12 1 100 0 0 f f f f t t i s 1 0 25 "3802" _null_ _null_ _null_ _null_ _null_ jsonb_extract_keys _null_ _null_ _null_ ));
...
DATA(insert OID = 3377 (  jsonb_canonical   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 25 "3802" _null_ _null_ _null_ _null_ _null_ jsonb_canonical _null_ _null_ _null_ ));
...
DATA(insert OID = 3401 (  json_ne			PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "114 114" _null_ _null_ _null_ _null_ _null_ json_ne _null_ _null_ _null_ ));
DATA(insert OID = 3402 (  json_lt			PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "114 114" _null_ _null_ _null_ _null_ _null_ json_lt _null_ _null_ _null_ ));
DATA(insert OID = 3403 (  json_gt			PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "114 114" _null_ _null_ _null_ _null_ _null_ json_gt _null_ _null_ _null_ ));
DATA(insert OID = 3404 (  json_le			PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "114 114" _null_ _null_ _null_ _null_ _null_ json_le _null_ _null_ _null_ ));
DATA(insert OID = 3405 (  json_ge			PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "114 114" _null_ _null_ _null_ _null_ _null_ json_ge _null_ _null_ _null_ ));
DATA(insert OID = 3406 (  json_eq			PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "114 114" _null_ _null_ _null_ _null_ _null_ json_eq _null_ _null_ _null_ ));
DATA(insert OID = 3407 (  json_cmp			PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 23 "114 114" _null_ _null_ _null_ _null_ _null_ json_cmp _null_ _null_ _null_ ));
DESCR("less-equal-greater");
DATA(insert OID = 3408 (  json_hash			PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 23 "114" _null_ _null_ _null_ _null_ _null_ json_hash _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 3409 (  json_contains		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "114 114" _null_ _null_ _null_ _null_ _null_ json_contains _null_ _null_ _null_ ));
DATA(insert OID = 3410 (  json_exists		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "114 25" _null_ _null_ _null_ _null_ _null_ json_exists _null_ _null_ _null_ ));
DATA(insert OID = 3411 (  json_exists_any	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "114 1009" _null_ _null_ _null_ _null_ _null_ json_exists_any _null_ _null_ _null_ ));
DATA(insert OID = 3412 (  json_exists_all	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "114 1009" _null_ _null_ _null_ _null_ _null_ json_exists_all _null_ _null_ _null_ ));
DATA(insert OID = 3413 (  json_contained	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 16 "114 114" _null_ _null_ _null_ _null_ _null_ json_contained _null_ _null_ _null_ ));

DATA(insert OID = 3414 (  json_concat		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 114 "114 114" _null_ _null_ _null_ _null_ _null_ json_concat _null_ _null_ _null_ ));
DATA(insert OID = 3415 (  json_delete		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 114 "114 25" _null_ _null_ _null_ _null_ _null_ json_delete _null_ _null_ _null_ ));
DATA(insert OID = 3416 (  json_delete		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 114 "114 23" _null_ _null_ _null_ _null_ _null_ json_delete_idx _null_ _null_ _null_ ));
DATA(insert OID = 3417 (  json_delete_path	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 114 "114 1009" _null_ _null_ _null_ _null_ _null_ json_delete_path _null_ _null_ _null_ ));
DATA(insert OID = 3418 (  json_set			PGNSP PGUID 12 1 0 0 0 f f f f t f i s 4 0 114 "114 1009 114 16" _null_ _null_ _null_ _null_ _null_ json_set _null_ _null_ _null_ ));
DESCR("Set part of a json");
DATA(insert OID = 3419 (  json_pretty		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 25 "114" _null_ _null_ _null_ _null_ _null_ json_pretty _null_ _null_ _null_ ));
DESCR("Indented text from json");
DATA(insert OID = 3420 (  json_canonical	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 25 "114" _null_ _null_ _null_ _null_ _null_ json_canonical _null_ _null_ _null_ ));
DESCR("Canonical text from json");
DATA(insert OID = 3421 (  json_insert		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 4 0 114 "114 1009 114 16" _null_ _null_ _null_ _null_ _null_ json_insert _null_ _null_ _null_ ));
DESCR("Insert value into a json");

DATA(insert OID = 3445 (  gin_compare_json				PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 23 "25 25" _null_ _null_ _null_ _null_ _null_ gin_compare_json _null_ _null_ _null_ ));
DESCR("GIN support");
DATA(insert OID = 3446 (  gin_extract_json				PGNSP PGUID 12 1 0 0 0 f f f f t f i s 3 0 2281 "114 2281 2281" _null_ _null_ _null_ _null_ _null_ gin_extract_json _null_ _null_ _null_ ));
DESCR("GIN support");
DATA(insert OID = 3447 (  gin_extract_json_query		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 7 0 2281 "114 2281 21 2281 2281 2281 2281" _null_ _null_ _null_ _null_ _null_ gin_extract_json_query _null_ _null_ _null_ ));
DESCR("GIN support");
DATA(insert OID = 3448 (  gin_consistent_json			PGNSP PGUID 12 1 0 0 0 f f f f t f i s 8 0 16 "2281 21 114 23 2281 2281 2281 2281" _null_ _null_ _null_ _null_ _null_ gin_consistent_json _null_ _null_ _null_ ));
DESCR("GIN support");
DATA(insert OID = 3449 (  gin_triconsistent_json		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 7 0 18 "2281 21 114 23 2281 2281 2281" _null_ _null_ _null_ _null_ _null_ gin_triconsistent_json _null_ _null_ _null_ ));
DESCR("GIN support");
DATA(insert OID = 3450 (  gin_extract_json_path			PGNSP PGUID 12 1 0 0 0 f f f f t f i s 3 0 2281 "114 2281 2281" _null_ _null_ _null_ _null_ _null_ gin_extract_json_path _null_ _null_ _null_ ));
DESCR("GIN support");
DATA(insert OID = 3451 (  gin_extract_json_query_path	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 7 0 2281 "114 2281 21 2281 2281 2281 2281" _null_ _null_ _null_ _null_ _null_ gin_extract_json_query_path _null_ _null_ _null_ ));
DESCR("GIN support");
DATA(insert OID = 3452 (  gin_consistent_json_path		PGNSP PGUID 12 1 0 0 0 f f f f t f i s 8 0 16 "2281 21 114 23 2281 2281 2281 2281" _null_ _null_ _null_ _null_ _null_ gin_consistent_json_path _null_ _null_ _null_ ));
DESCR("GIN support");
DATA(insert OID = 3453 (  gin_triconsistent_json_path	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 7 0 18 "2281 21 114 23 2281 2281 2281" _null_ _null_ _null_ _null_ _null_ gin_triconsistent_json_path _null_ _null_ _null_ ));
DESCR("GIN support");
